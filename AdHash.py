...
file_handler_info = logging.FileHandler("E:\\Opencv_project\\Log\\Info.log")
...
file_handler_error = logging.FileHandler("E:\\Opencv_project\\Log\\Error.log")
# file_handler_error.setLevel(logging.ERROR)
formatter2 = logging.Formatter(format_error, datefmt='%d-%b-%Y - %I:%M:%S %p')
file_handler_error.setFormatter(formatter2)

file_handler_output = logging.FileHandler("E:\\Opencv_project\\Log\\Output.log")

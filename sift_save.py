...
for (i, basePath) in enumerate(basePaths):
    ...
    for point in kp1:
        temp = (point.pt, point.size, point.angle, point.response, point.octave, point.class_id, saveBase.append(temp))

   # file = open("C:\\Users\\Roshan\\Desktop\\New folder\\keypointTxt.txt", "w")
   # file.write(str(pickle.dumps(saveBase)))
   # file.close()

    #a_file = open("C:\\Users\\Roshan\\Desktop\\New folder\\keypoints_des2.txt", "w")
    #for row in des1:
